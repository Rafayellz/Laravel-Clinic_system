        ...
        <div class="row">
            ...
            <main class="col-lg-10 col-md-9 ms-sm-auto px-md-4 py-4">
                ...
                <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
                    <h1 class="h2">Welcome, {{ $user->first_name }} {{ $user->last_name}}</h1> <!-- dapat ma butang ang user name dria-->
                            ...
                            <div class="card-body">
                                ...
                                @else
                                    <div class="text-center py-4">
                                        ...
                                        <a href="{{ route('bookappointment') }}" class="btn btn-success btn-sm">
                                            <i class="fas fa-calendar-plus me-2"></i>Book Appointment
                                        </a>
                                    </div>
                                @endif
                    ...
                    <div class="col-md-4 mb-4">
                        <div class="card h-100">
                            ...
                            <div class="card-body text-center">
                                ...
                                <p class="card-text">Student ID: {{ $user->id_number}}</p>
                                <p class="card-text">
                                    <span class="appointment-badge me-2">2 Upcoming</span>
                        ...
                        <div class="card">
                            ...
                            <div class="card-body">
                                ...
                                <div class="text-center mt-3">
                                    <a href="{{ route('myappointment') }}" class="btn btn-primary-custom">View All Appointments</a>
                                </div>
                            </div>
                        </div>
                    </div>
